	...
	return []*GenericCertificate{
		{
			...
			Secret:   secretForType(cert, CertificateFile),
			HTTP:     httpSettings,
		...
		},
		{
			...
			Secret:   secretForType(cert, KeyFile),
			HTTP:     httpSettings,
			Type:     KeyFile,
		},
		{
			...
			Secret:   secretForType(cert, CaCertificateFile),
			HTTP:     httpSettings,
		...
		},
		{
			...
			Secret:   secretForType(cert, PrivateCertFile),
			HTTP:     httpSettings,
		...
		},
		{
			...
			Secret:   secretForType(cert, PrivateCertChainFile),
			HTTP:     httpSettings,
